...
class DrupalCommands extends Drupal8Commands
{
     ...
     *
     * You can specify additional settings.php portions in your local runner.yml.dist/runner.yml
     * as shown below:
     *
     * > drupal:
     * >   additional_settings: |
     ...
     *
     * You can specify additional service parameters in your local runner.yml.dist/runner.yml
     * as shown below:
     *
     * > drupal:
     * >   service_parameters:
