...
class ReleaseCommandsTest extends AbstractTest
{
    ...
    {
        return self::getFixtureContent('commands/release.yml');
    }
     ...
     */
    public function testToolkitRelease(string $command, array $configuration = [], array $resources = [], array $expectations = [])
    {
