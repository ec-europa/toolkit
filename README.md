...
- [Building the codebase](docs/building-codebase#building-the-codebase)
    - [Platform builds](docs/building-codebase#platform-builds)
    - [Subsite builds](docs/building-codebase#subsite-builds)
    - [Theme builds](docs/building-codebase#theme-builds)
